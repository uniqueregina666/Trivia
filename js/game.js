$(document).ready(function() {
    ...
    function generateLoss() {
        incorrectTally++;
        gameHTML = "<p class='text-center timer-p'>Time Remaining: <span class='timer'>" + counter + "</span></p>" + "<p class='text-center'>Wrong! The correct answer is: "+ correctAnswers[questionCounter] + "</p>" + "<img class='center-block img-wrong' src='images/wrong.jpg'>";
        $(".mainArea").html(gameHTML);
        setTimeout(wait, 4000); //  change to 4000 or other amount
    }
    ...
    var imageArray = ["<img class='center-block img-right' id='p1' src='images/queen.jpg'>", "<img class='center-block img-right' id='p2' src='images/journey.jpg'>", "<img class='center-block img-right' id='p3' src='images/thebeatles.jpg'>", "<img class='center-block img-right' id='p4' src='images/greenday.jpg'>", "<img class='center-block img-right' id='p5' src='images/bsb.jpg'>", "<img class='center-block img-right' id='p6'src='images/nd.jpg'>", "<img class='center-block img-right' id='p7' src='images/proclaimer.gif'>", "<img class='center-block img-right' id='p8' src='images/rs.jpg'>"];
